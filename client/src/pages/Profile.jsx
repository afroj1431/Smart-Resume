      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        >
          ...
          <p className="text-white/80 leading-relaxed">
            ...
            with AI-powered analysis, ATS scoring, and personalized job matching. Upload your resume 
            to get instant insights and improve your chances of landing your dream job.
          </p>
        </motion.div>
      </div>
    </DashboardLayout>
